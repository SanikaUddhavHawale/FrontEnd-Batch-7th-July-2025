...
let s=2;
let t=3;
console.log("Post increment : "+(s++));//s=2  // first assign then increament
console.log(s);//s=3
console.log("Post decrement : "+(t--));//t=3  // first assign then decrement
console.log(t);//t=2
console.log("pre increment : "+ (++s));//s=4  // first increment then assign
console.log(s);//4
console.log("pre decrement : "+(--t));//t=1   // first decrement then assign
console.log(t);//1
